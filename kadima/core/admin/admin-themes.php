<?php if (!function_exists('kadima_info_page')) {
	function kadima_info_page() {
	$page1=add_theme_page(__('Welcome to Kadima', 'kadima'), __('Pro Themes & Plugin', 'kadima'), 'edit_theme_options', 'kadima', 'kadimadisplay_theme_info_page');
	
	add_action('admin_print_styles-'.$page1, 'kadima_admin_info');
	}	
}
add_action('admin_menu', 'kadima_info_page');

function kadima_admin_info(){
	// CSS
...
if (!function_exists('kadimadisplay_theme_info_page')) {
	function kadimadisplay_theme_info_page() {
		...
		<div class="row p_plugin blog_gallery">
			<div class="col-xs-12 col-sm-4 col-md-5 p_plugin_pic">
				<div class="img-thumbnail">
					<img src="<?php echo get_template_directory_uri(); ?>/images/Kadima.jpg" class="img-responsive" alt=""/>
				</div>
			</div>
			<div class="col-xs-12 col-sm-5 col-md-5 p_plugin_desc">
				<div class="row p-box">
					<h2><a href="">Kadima- Ultimate Multi-Purpose WordPress Theme</a></h2>
						...
						Kadima is a Full Responsive Multi-Purpose Theme suitable for Business , corporate office and others .Cool Blog Layout and full width page also present.</p>
						</div>
				</div>
			</div>
			<div class="col-xs-12 col-sm-3 col-md-2 p_plugin_pic">
				...
				<div class="btn-group-vertical">
					<a class="btn btn-primary btn-lg" href="https://weblizar.com/themes/kadima-premium/">Detail</a>
					<a class="btn btn-success btn-lg" href="https://weblizar.com/themes/kadima-premium/">Buy Now</a>
				</div>			
			</div>
		</div>
		<div class="row p_plugin blog_gallery">
...
<div class="container-fluid space p_front plugin hidden">
	...
	<div id="theme-author">
		<p><?php printf(__('%1s is proudly brought to you by %2s. If you like this WordPress theme, %3s.', 'kadima'),
			$theme_data->Name,
			'<a target="_blank" href="https://weblizar.com/" title="weblizar">Weblizar</a>',
			'<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/kadima" title="Kadima Review">' . __('rate it', 'kadima') . '</a>'); ?>
		</p>
	</div>
</div>
<?php
